...
public class MySqlTest {
    ...
    @Test
    public void testInsertAndDeleteByPrimaryKeyAndUpdate() throws SQLException {
        TestEntity testEntity = new TestEntity();
//        testEntity.setName("tsetest");
//        long insert = mySqlMapper.insert(testEntity);
        TestEntity testEntity2 = new TestEntity();
//        testEntity2.setId(1L);
        DataSource beanById = SpringContextHelper.getBeanById("datasource-default");
//        Connection connection = beanById.getConnection();
//        System.out.println(connection);
        long insert2 = mySqlMapper.insert(testEntity2);
        Assert.assertTrue(testEntity2.getId() != null);
        testEntity2.setName("q23");
        int i = mySqlMapper.updateByPrimaryKey(testEntity2);
        int delete = mySqlMapper.deleteByPrimaryKey(testEntity2.getId());
    }
