...
import com.czy.seed.mybatis.mapper.DcsCountryMapper;
...
public class SqlServerTest {
    ...
    @Autowired
    private SqlServerMapper sqlMapper;
    @Autowired
    private DcsCountryMapper dcsCountryMapper;
...
//        queryParams.selectProperties("name");
    ...
    @Test
    public void testSelectOneByParams2() {
        QueryParams queryParams = new QueryParams(DcsCountry.class);
        queryParams.selectProperties("passportvalid");
        QueryParams.Criteria criteria = queryParams.createCriteria();
        criteria.andEqualTo("countryIataThree","ALB");
        DcsCountry dcsCountry = dcsCountryMapper.selectOneByParams(queryParams);
        System.out.println(dcsCountry.getId());
    }
